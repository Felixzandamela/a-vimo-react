...
const SupportChat =({language})=>{
  ...
  useEffect(()=>{
    const noChatStarted = (/^\/admin\/support$/i.test(location.pathname));
      ...
      <div className="sec_chat flex_b">
        <div className="a_chats_list a_width_40">
          <div className="a_box_o">
            <div className="a_chat_list_header flex_b_c">
              <div onClick={()=>navigate(-1,{replace:true})} className="flex_c_c btn_circle"> 
              ...
              <div className="flex_e_c a_search_card_b a_conatiner">
