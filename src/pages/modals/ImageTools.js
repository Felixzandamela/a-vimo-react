    ...
    {fileName && <div className="popUp flex_c_c">
     <div className="card_popup a_conatiner">
        ...
        <div className="modal_body">
          ...
          <button type="button" onClick={handlePreviewClick} disabled={loading} className="btns main_btns">{loading && <MinLoder/> || texts._continue[language]}</button>
          </div>
        </div>
      </div>
    </div>}
...
export const ImageViewer = ({language,datas,onClose}) =>{
  ...
  return(
    <div className="images_swipper_container flex_c_c">
      <div className="images_swipper_wrap a_conatiner">
